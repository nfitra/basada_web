	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item <?= ($fc == "home" && $fm == "index") ? "active" : "" ?>">
					<a href="<?= base_url('home/index') ?>" class="nav-link">Home</a>
				</li>
				<li class="nav-item <?= ($fc == "home" && $fm == "artikel") ? "active" : "" ?>">
					<a href="<?= base_url('home/artikel') ?>" class="nav-link">Artikel</a>
				</li>
				<li class="nav-item <?= ($fc == "home" && $fm == "tutorial") ? "active" : "" ?>">
					<a href="<?= base_url('home/tutorial') ?>" class="nav-link">Tutorial</a>
				</li>
				<li class="nav-item dropdown <?= ($fc == "home" && ($fm == "sampah" || $fm == "jadwal_sampah")) ? "active" : "" ?> ">
				...
				<li class="nav-item <?= ($fc == "auth" && $fm == "index") ? "active" : "" ?>">
