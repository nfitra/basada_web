                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="border p-3 rounded">
                                ...
                                <input type="text" placeholder="ex: Your Contact" class="form-control mb-3" name="un_contact" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="border p-3 rounded">
                                ...
                                <input type="text" placeholder="ex: Your District" class="form-control mb-3" name="un_district" />
                                <label for="">Location</label>
                                <input type="text" placeholder="ex: Unit Long and Lat" class="form-control mb-3" name="un_location" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <button class="btn btn-warning text-black btn-block">Tambah Data Unit</button>
                        </div>
                    </div>
                </form>
            </div>
