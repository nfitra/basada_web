...
$route['api/request/unit']['get'] = 'api/RequestSampah/get_request_by_current_unit';
...
$route['api/request-by-unit/(:any)']['get'] = 'api/RequestSampah/get_request_by_unit/$1';
$route['api/request-by-unit-jadwal/(:any)/(:any)']['get'] = 'api/RequestSampah/get_request_by_unit_jadwal/$1/$2';
$route['api/request/unit/jadwal/(:any)']['get'] = 'api/RequestSampah/get_request_by_current_unit_jadwal/$1';

// $route['api/admin']['get'] = 'api/Admin/get_admin';
$route['api/unit']['get'] = 'api/Unit/get_unit';
$route['api/unit/(:any)']['get'] = 'api/Unit/get_unit_by_status/$1';
$route['api/admin']['put'] = 'api/Admin/update_admin';
$route['api/admin/profile']['get'] = 'api/Admin/profile';
$route['api/unit']['put'] = 'api/Unit/update_unit';
$route['api/unit/profile']['get'] = 'api/Unit/profile';
